package sh.harold.fulcrum.message.example;
...
public class MessageExample {
    ...
    public void demonstrateChainedUsage() {
        ...
        String message = Message.info(playerId, "player.stats.summary", "kills", 42)
                               .staff().debug().build();
        // Gets the formatted string without sending it
        
        // MESSAGES WITHOUT TAGS (traditional usage)
        Message.success(playerId, "operation.completed").send();

...
class MockStatement implements Statement {
    ...
    @Override public boolean execute(String sql) throws SQLException { executedSql.add(sql); return true; }
...
class MockConnection implements Connection {
    ...
    @Override public Statement createStatement() { return statement; }
    // ...existing code...
    @Override public void close() {}
    // All other methods throw or are no-ops
    @Override public <T> T unwrap(Class<T> iface) { throw new UnsupportedOperationException(); }
    ...
    @Override public void clearWarnings() {}
    @Override public java.sql.Statement createStatement(int resultSetType, int resultSetConcurrency) { return statement; }
    @Override public java.sql.Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) { return statement; }

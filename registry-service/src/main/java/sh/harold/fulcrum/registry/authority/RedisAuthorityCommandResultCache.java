...
public final class RedisAuthorityCommandResultCache implements CachedAuthorityCommandPort.CommandResultCache {
    private static final String PREFIX = "fulcrum:authority:idempotency-result:";
    ...
    private static String cacheKey(String idempotencyKey) {

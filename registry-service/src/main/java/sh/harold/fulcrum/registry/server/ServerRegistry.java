...
public class ServerRegistry {
    ...
    private static RuntimeAuthorityDeliveryManifest authorityDeliveryManifest(Object value) {
        ...
        manifest.setAuthorityDomainTopologyFingerprint(stringValue(raw.get("authorityDomainTopologyFingerprint"), null));
        manifest.setAuthorityServicesByDomain(stringMap(raw.get("authorityServicesByDomain")));
        manifest.setAuthorityConsumerGroupsByDomain(stringMap(raw.get("authorityConsumerGroupsByDomain")));
        manifest.setAuthorityPrincipalsByDomain(stringMap(raw.get("authorityPrincipalsByDomain")));
        ...
        manifest.setCommandAuthorityServicesByType(stringMap(raw.get("commandAuthorityServicesByType")));
        manifest.setCommandConsumerGroupsByType(stringMap(raw.get("commandConsumerGroupsByType")));
        manifest.setCommandAuthorityPrincipalsByType(stringMap(raw.get("commandAuthorityPrincipalsByType")));
        manifest.setCommandPartitionCountsByType(stringMap(raw.get("commandPartitionCountsByType")));
        manifest.setCommandTopicsByType(stringMap(raw.get("commandTopicsByType")));
        manifest.setCommandResponseTopicsByType(stringMap(raw.get("commandResponseTopicsByType")));
        manifest.setCommandEventTopicsByType(stringMap(raw.get("commandEventTopicsByType")));
        manifest.setCommandStateTopicsByType(stringMap(raw.get("commandStateTopicsByType")));

...
final class AuthorityLogFrames {
    ...
    private static AuthorityLogRecord appendEvent(
        ...
        MapBuilder payload = new MapBuilder()
            ...
            .put("declarationId", command.declarationId())
    ...
    private static Map<String, Object> commandPayload(
        ...
        return new MapBuilder()
            ...
            .put("contractFingerprint", AuthorityCommandManifest.fingerprint())
            .put("routeManifestFingerprint", AuthorityCommandManifest.routeManifestFingerprint())

...
dependencies {
    ...
    implementation(project(":capability:capability-bundle-runtime"))
...
val operatorDeploymentSurfaceTest by tasks.registering(Test::class) {
    ...
    filter {
        ...
        includeTestsMatching("sh.harold.fulcrum.distribution.launcher.FulcrumLauncherTest.operatorUpExecutesFullEngineComposePlan")
        includeTestsMatching("sh.harold.fulcrum.distribution.launcher.FulcrumLauncherTest.operatorStatusAndDownUseSavedRunPlan")
        includeTestsMatching("sh.harold.fulcrum.distribution.launcher.FulcrumLauncherTest.operatorStatusAndDownSuperviseRunningComposePlan")
        includeTestsMatching("sh.harold.fulcrum.distribution.launcher.FulcrumLauncherTest.operatorUpDryRunRoutesProductionProfileToHelmPlan")
        includeTestsMatching("sh.harold.fulcrum.distribution.launcher.FulcrumLauncherTest.operatorUpExecutesProductionHelmPlan")
        includeTestsMatching("sh.harold.fulcrum.distribution.launcher.FulcrumLauncherTest.operatorStatusAndDownSuperviseRunningHelmPlan")
        includeTestsMatching("sh.harold.fulcrum.distribution.launcher.FulcrumLauncherTest.operatorClusterUpDryRunWritesK3dHelmPlan")
        includeTestsMatching("sh.harold.fulcrum.distribution.launcher.FulcrumLauncherTest.operatorClusterLifecycleUsesSavedPlan")
...
val authorLoopSurfaceTest by tasks.registering(Test::class) {
    group = "verification"
    description = "Runs the Phase 5 author scaffold, reload, one-click test, and publish loop contract tests."

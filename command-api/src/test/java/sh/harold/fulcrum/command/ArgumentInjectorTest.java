...
// Minimal CommandSender stub for test isolation
...
class MinimalSender implements org.bukkit.command.CommandSender {
    ...
    @Override public boolean hasPermission(org.bukkit.permissions.Permission perm) { return false; }
    ...
    @Override public Component name() { return Component.text("dummy"); }
    @Override public org.bukkit.command.CommandSender.Spigot spigot() { throw new UnsupportedOperationException(); }
}

class ArgumentInjectorTest {
    static class FakeCommandContext extends CommandContext {
        private final Map<String, Object> values;
        public FakeCommandContext(Map<String, Object> values) { super(new MinimalSender()); this.values = values; }
        @Override public <T> T argument(String name, Class<T> type) {
    ...
    static class TestCommand implements CommandExecutor {
        @Argument("name") public String name;
        @Argument("age") public int age;
        @Argument("id") public UUID id;
        @Argument("privateField") private String privateField;

...
import sh.harold.fulcrum.velocity.fundamentals.environment.VelocityEnvironmentDirectoryFeature;
...
public class VelocityFeatureManager {
    ...
    public void loadFundamentalFeatures() {
        ...
        registerFeature(new sh.harold.fulcrum.velocity.status.VelocityStatusFeature());
